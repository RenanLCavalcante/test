	...
	<div class="container">
		...
		<div id="divMain">
			<form id="formulario_cadastro">
				...
				<div class="checkbox">
					<label> <input type="checkbox" value="1" name="ativo" id="ativo">Ativo
					</label>
				</div>

				<div class="form-group">
					<label for="departamento">Departamento</label> <select
						name="departamento" class="form-control" id="departamento">
				...
				<input type="button" value="Add Usuário" id="cadastrar" class="btn btn-info">
